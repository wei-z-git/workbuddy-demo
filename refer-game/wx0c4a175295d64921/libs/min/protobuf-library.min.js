...
(function(global, undefined) {
  ...
  (function prelude(modules, cache, entries) {
    ...
    if ((typeof module === "undefined" ? "undefined" : _typeof2(module)) === "object" && module && module.exports) module.exports = protobuf;
  })({
      ...
      function factory(exports) {
        if (typeof Float32Array !== "undefined")(function() {
          ...
          function writeFloat_ieee754(writeUint, val, buf, pos) {
            ...
            else if (val > 3.4028234663852886e38) writeUint((sign << 31 | 2139095040) >>> 0, buf, pos);
        ...
        for (; i < mtype.fieldsArray.length; ++i) {
          ...
          if (field.map) {
            ...
            if (types.long[field.keyType] !== undefined) {
              if (types.basic[type] === undefined) gen('%s[typeof k==="object"?util.longToHash(k):k]=types[%i].decode(r,r.uint32())', ref, i);
              else gen('%s[typeof k==="object"?util.longToHash(k):k]=r.%s()', ref, type);
            } else {
              if (types.basic[type] === undefined) gen("%s[k]=types[%i].decode(r,r.uint32())", ref, i);
    ...
    15: [function(require, module, exports) {
      ...
      function Enum(name, values, options) {
        ...
        if (values && _typeof2(values) !== "object") throw TypeError("values must be an object");
        this.valuesById = {};
    ...
    16: [function(require, module, exports) {
      ...
      Field.d = function decorateField(fieldId, fieldType, fieldRule, defaultValue) {
        ...
        else if (fieldType && _typeof2(fieldType) === "object") fieldType = util.decorateEnum(fieldType).name;
    ...
    20: [function(require, module, exports) {
      ...
      MapField.d = function decorateMapField(fieldId, fieldKeyType, fieldValueType) {
        ...
        else if (fieldValueType && _typeof2(fieldValueType) === "object") fieldValueType = util.decorateEnum(fieldValueType).name;
    ...
    22: [function(require, module, exports) {
      ...
      Method.prototype.toJSON = function toJSON() {
        return util.toObject(["type", this.type !== "rpc" && this.type || undefined, "requestType", this.requestType, "requestStream", this.requestStream, "responseType", this.responseType, "responseStream", this.responseStream, "options", this.options]);
      };
    ...
    24: [function(require, module, exports) {
      ...
      ReflectionObject.prototype.setOptions = function setOptions(options, ifNotSet) {
        if (options)
          for (var keys = Object.keys(options), i = 0; i < keys.length; ++i) this.setOption(keys[i], options[keys[i]], ifNotSet);
        return this;
      };
    ...
    33: [function(require, module, exports) {
      ...
      Service.fromJSON = function fromJSON(name, json) {
        ...
        if (json.methods)
          for (var names = Object.keys(json.methods), i = 0; i < names.length; ++i) service.add(Method.fromJSON(names[i], json.methods[names[i]]));
    ...
    39: [function(require, module, exports) {
      ...
      util.isset = util.isSet = function isSet(obj, prop) {
        var value = obj[prop];
        if (value != null && obj.hasOwnProperty(prop)) return _typeof2(value) !== "object" || (Array.isArray(value) ? value.length : Object.keys(value).length) > 0;
        return false;
      };
    ...
    43: [function(require, module, exports) {
      ...
      var writeBytesBuffer = Buffer && Buffer.prototype instanceof Uint8Array && Buffer.prototype.set.name === "set" ? function writeBytesBuffer_set(val, buf, pos) {
        ...
        if (val.copy) val.copy(buf, pos, 0, val.length);
          ...
          for (var i = 0; i < val.length;) buf[pos++] = val[i++];
      };
...
})((typeof window === "undefined" ? "undefined" : _typeof2(window)) === "object" && window || (typeof self === "undefined" ? "undefined" : _typeof2(self)) === "object" && self || void 0);