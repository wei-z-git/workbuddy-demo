...
! function(t, e) {
  ...
  var a = /*#__PURE__*/ _createClass2(function a() {
  ...
  var n = /*#__PURE__*/ function() {
    ...
    _createClass2(n, null, [{
      ...
      value: function parse(t, _n) {
        ...
        t._aniClassName = m;
        var x,
          y = _n.readUTFString().split("\n"),
          g = _n.getUint8(),
          f = _n.getUint32(),
          M = _n.getUint32();
        f > 0 && (x = c.slice(f, M));
        var D = new e.Byte(x);
        for (M > 0 && (t._publicExtData = c.slice(M, c.byteLength)), t._useParent = !!_n.getUint8(), t._anis.length = g, h = 0; h < g; h++) {
          var v = t._anis[h] = new a();
          v.nodes = [];
          var I = v.name = y[_n.getUint16()];
          t._aniMap[I] = h, v.bone3DMap = {}, v.playTime = _n.getFloat32();
          var A = v.nodes.length = _n.getUint8();
          for (v.totalKeyframeDatasLength = 0, l = 0; l < A; l++) {
            var T = v.nodes[l] = new r();
            T.childs = [];
            var S = _n.getInt16();
            S >= 0 && (T.name = y[S], v.bone3DMap[T.name] = l), T.keyFrame = [], T.parentIndex = _n.getInt16(), -1 == T.parentIndex ? T.parent = null : T.parent = v.nodes[T.parentIndex], T.lerpType = _n.getUint8();
            var b = _n.getUint32();
            D.pos = b;
            ...
            var F = _n.getUint16();
            F > 0 && (T.extenData = c.slice(_n.pos, _n.pos + F), _n.pos += F);
            var w = _n.getUint16();
            T.keyFrame.length = w;
            var k,
              P = 0;
            for (o = 0, u = w; o < u; o++) {
              if ((k = T.keyFrame[o] = new s()).duration = _n.getFloat32(), k.startTime = P, 2 === T.lerpType) {
                k.interpolationData = [];
                var L,
                  U = _n.getUint8();
                switch (L = _n.getFloat32()) {
                  case 254:
                  ...
                  case 255:
                    ...
                    break;
                  default:
                    for (k.interpolationData.push(L), p = 1; p < U; p++) k.interpolationData.push(_n.getFloat32());
                }
              }
              for (k.data = new Float32Array(C), k.dData = new Float32Array(C), k.nextData = new Float32Array(C), _ = 0; _ < C; _++) k.data[_] = _n.getFloat32(), k.data[_] > -1e-8 && k.data[_] < 1e-8 && (k.data[_] = 0);
              P += k.duration;
            }
  ...
  var l = /*#__PURE__*/ _createClass2(function l() {
    _classCallCheck2(this, l);
  });
  l.stopped = 0, l.paused = 1, l.playing = 2;
  var o = /*#__PURE__*/ function(_e$EventDispatcher) {
    _inherits2(o, _e$EventDispatcher);
    var _super = _createSuper2(o);

    function o() {
      var _this;
      _classCallCheck2(this, o);
      _this = _super.call(this), _this.isCache = !0, _this.playbackRate = 1, _this._destroyed = !1, _this._currentAnimationClipIndex = -1, _this._currentKeyframeIndex = -1, _this._currentTime = 0, _this._overallDuration = Number.MAX_VALUE, _this._stopWhenCircleFinish = !1, _this._elapsedPlaybackTime = 0, _this._startUpdateLoopCount = -1, _this._cachePlayRate = 1, _this.cacheFrameRate = 60, _this.returnToZeroStopped = !1;
      return _this;
    }
    _createClass2(o, [{
      key: "templet",
  ...
  var _ = /*#__PURE__*/ function(_e$Resource) {
    _inherits2(_, _e$Resource);
    var _super2 = _createSuper2(_);

    function _() {
      var _this2;
      _classCallCheck2(this, _);
      _this2 = _super2.call(this), _this2._anis = [], _this2._aniMap = {}, _this2.unfixedLastAniIndex = -1, _this2._fullFrames = null, _this2._boneCurKeyFrm = [];
      return _this2;
    }
    _createClass2(_, [{
      key: "parse",
      ...
      value: function _QuaternionInterpolation_1(t, i, a, r, s, n, h, l, o) {
        ...
        var _2 = 0 === l ? 0 : n / l;
        return e.MathUtil.slerpQuaternionArray(s, i, o, i, _2, a, r), 4;
      }
    }, {
      ...
      value: function _BezierInterpolation_6(t, e, i, a, r, s, n, h, l) {
        var o = arguments.length > 9 && arguments[9] !== undefined ? arguments[9] : null;
        var _3 = arguments.length > 10 && arguments[10] !== undefined ? arguments[10] : 0;
        return i[a] = r[e] + (l[e] - r[e]) * u.getBezierRate(s / h, o[_3], o[_3 + 1], o[_3 + 2], o[_3 + 3]), 5;
      }
    }, {
      key: "_BezierInterpolation_7",
      value: function _BezierInterpolation_7(t, e, i, a, r, s, n, h, l) {
        var o = arguments.length > 9 && arguments[9] !== undefined ? arguments[9] : null;
        var _4 = arguments.length > 10 && arguments[10] !== undefined ? arguments[10] : 0;
        return i[a] = o[_4 + 4] + o[_4 + 5] * u.getBezierRate((.001 * s + o[_4 + 6]) / o[_4 + 7], o[_4], o[_4 + 1], o[_4 + 2], o[_4 + 3]), 9;
      }
    }]);
    return _;
  }(e.Resource);
  ...
  var p = /*#__PURE__*/ function(_e$Graphics) {
    _inherits2(p, _e$Graphics);
    var _super3 = _createSuper2(p);
  ...
  var f = /*#__PURE__*/ _createClass2(function f() {
    _classCallCheck2(this, f);
    this.deformSlotDataList = [];
  });
  var M = /*#__PURE__*/ _createClass2(function M() {
    _classCallCheck2(this, M);
  ...
  var v = /*#__PURE__*/ _createClass2(function v() {
      ...
      value: function _applyIk3(t, i, a, r, s, n) {
        ...
        if (p + M <= v || v + p <= M || v + M <= p) {
          ...
          var _t2 = (f - _ + D) / (2 * D),
            ...
            _r = -g * _e,
            _n2 = y * _e;
          s > 0 ? (m = _i - _r, x = _a - _n2) : (m = _i + _r, x = _a + _n2);
        }
        var T, S, b, C;
  ...
  var T = /*#__PURE__*/ _createClass2(function T() {
    ...
    _createClass2(S, [{
      ...
      value: function computeWorldPositions(t, e, i, a, r, s, n) {
        ...
        var A,
          ...
          O = 0,
          V = 0;
        for (x = 0, P = 2; x < D; x++, P += 6) C = 2 * (A = .1875 * (L - 2 * (B = h[P]) + (R = h[P + 2]))) + (_S2 = .09375 * (3 * (B - R) - L + (O = h[P + 4]))), F = 2 * (T = .1875 * (U - 2 * (E = h[P + 1]) + (N = h[P + 3]))) + (b = .09375 * (3 * (E - N) - U + (V = h[P + 5]))), w = .75 * (B - L) + A + .16666667 * _S2, k = .75 * (E - U) + T + .16666667 * b, l += Math.sqrt(w * w + k * k), w += C, k += F, C += _S2, F += b, l += Math.sqrt(w * w + k * k), w += C, k += F, l += Math.sqrt(w * w + k * k), w += C + _S2, k += F + b, l += Math.sqrt(w * w + k * k), I[x] = l, L = O, U = V;
        if (s && (g *= l), n)
          for (x = 0; x < a; x++) f[x] *= l;
        var Y,
          K = this._segments,
        ...
        for (x = 0, o = 0, u = 0, Y = 0; x < a; x++, o += 3)
          ...
          if (u != v) {
            v = u;
            var W = 6 * u;
            for (C = 2 * (A = .03 * ((L = h[W]) - 2 * (B = h[W + 2]) + (R = h[W + 4]))) + (_S2 = .006 * (3 * (B - R) - L + (O = h[W + 6]))), F = 2 * (T = .03 * ((U = h[W + 1]) - 2 * (E = h[W + 3]) + (N = h[W + 5]))) + (b = .006 * (3 * (E - N) - U + (V = h[W + 7]))), w = .3 * (B - L) + A + .16666667 * _S2, k = .3 * (E - U) + T + .16666667 * b, X = Math.sqrt(w * w + k * k), K[0] = X, W = 1; W < 8; W++) w += C, k += F, C += _S2, F += b, X += Math.sqrt(w * w + k * k), K[W] = X;
            w += C, k += F, X += Math.sqrt(w * w + k * k), K[8] = X, w += C + _S2, k += F + b, X += Math.sqrt(w * w + k * k), K[9] = X, Y = 0;
          }
          for (_ *= X;; Y++)
            if (!(_ > (c = K[Y]))) {
  ...
  var b = /*#__PURE__*/ _createClass2(function b() {
  ...
  var F = /*#__PURE__*/ function(_e$Sprite) {
    _inherits2(F, _e$Sprite);
    var _super5 = _createSuper2(F);
    ...
    _createClass2(F, [{
      ...
      value: function _onLoaded() {
        var t,
          a = e.ILaya.Loader.getRes(this._aniPath);
      ...
      value: function _onStop() {
        var t,
          i = this._templet.eventAniArr[this._aniClipIndex];
      ...
      value: function _update() {
        ...
        if (!(t && this._pause || t && this._indexControl)) {
          ...
          if (t ? this._player._update(r) : a = -1, this._lastTime = i, this._player && (this._index = this._clipIndex = this._player.currentKeyframeIndex, !(this._index < 0 || r > 0 && this._clipIndex == a && this._lastUpdateAniClipIndex == this._aniClipIndex))) {
            ...
            var s,
              n,
              h = this._templet.eventAniArr[this._aniClipIndex];
      ...
      value: function _createGraphics() {
        ...
        var i,
          a = t * this._player.cacheFrameRateInterval,
        ...
        var l,
          ...
          u,
          _,
          d = this._aniSectionDic[this._aniClipIndex],
          c = 0,
          m = 0,
          x = 0,
          y = 0,
        ...
        if (this._pathDic)
          for (var _F in this._pathDic)(T = this._pathDic[_F]).apply(this._boneList, s);
        if (this._tfArr)
      ...
      value: function destroy() {
        var t = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : !0;
        _get2(_getPrototypeOf2(F.prototype), "destroy", this).call(this, t), this._templet._removeReference(1), this._templet = null, this._player && this._player.offAll(), this._player = null, this._curOriginalData = null, this._boneMatrixArray.length = 0, this._lastTime = 0, this.timer.clear(this, this._update), this._soundChannelArr.length > 0 && this._onAniSoundStoped(!0);
      }
    }, {
      key: "index",
      get: function get() {
  ...
  var w = /*#__PURE__*/ _createClass2(function w() {
    ...
    _createClass2(U, [{
      ...
      value: function _parseTexturePath() {
        if (this._isDestroyed) this.destroy();
          ...
          this._loadList = [];
          var i,
            a = new e.Byte(this.getPublicExtData()),
            r = a.getInt32(),
            s = a.readUTFString(),
            n = s.split("\n");
      ...
      value: function _parsePublicExtData() {
        ...
        var h,
          l,
          o = new e.Byte(this.getPublicExtData()),
          u = 0,
          _ = 0,
          p = 0,
          m = 0,
          ...
          B = _U.split("\n");
        for (i = 0; i < F; i++) {
          if (h = this._mainTexture, l = this._path + B[2 * i], _U = B[2 * i + 1], null == this._mainTexture && (h = this._textureDic[l]), !h) return this.event(e.Event.ERROR, this), void(this.isParseFail = !0);
          u = o.getFloat32(), _ = o.getFloat32(), p = o.getFloat32(), m = o.getFloat32(), C = o.getFloat32(), x = isNaN(C) ? 0 : C, C = o.getFloat32(), y = isNaN(C) ? 0 : C, C = o.getFloat32(), A = isNaN(C) ? p : C, C = o.getFloat32(), S = isNaN(C) ? m : C, this.subTextureDic[_U] = e.Texture.create(h, u, _, p, m, -x, -y, A, S);
        }
        this._mainTexture = h;
        var E,
          R,
      ...
      value: function _setCreateURL(t) {
        this._skBufferUrl = this._relativeUrl = t, _get2(_getPrototypeOf2(U.prototype), "_setCreateURL", this).call(this, t);
      }
    }, {
      ...
      value: function destroy() {
        ...
        this.skinSlotDisplayDataArr.length = 0, this._relativeUrl && delete U.TEMPLET_DICTIONARY[this._relativeUrl], _get2(_getPrototypeOf2(U.prototype), "destroy", this).call(this), e.ILaya.loader.clearRes(this._skBufferUrl);
      }
    }, {
      key: "getAniNameByIndex",
      value: function getAniNameByIndex(t) {
  ...
  var B = /*#__PURE__*/ function(_e$Sprite2) {
    _inherits2(B, _e$Sprite2);
    var _super7 = _createSuper2(B);

    function B() {
      var _this5;
      var t = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
      _classCallCheck2(this, B);
      _this5 = _super7.call(this), _this5._start = 0, _this5._Pos = 0, _this5._ended = !0, _this5._loadedImage = {}, _this5._endFrame = -1, _this5.interval = 30, _this5._ids = {}, _this5._idOfSprite = [], _this5._reset(), _this5._playing = !1, _this5._parentMovieClip = t, t ? (_this5._isRoot = !1, _this5._movieClipList = t._movieClipList, _this5._movieClipList.push(_assertThisInitialized2(_this5))) : (_this5._movieClipList = [_assertThisInitialized2(_this5)], _this5._isRoot = !0, _this5._setBitUp(e.Const.DISPLAY));
      return _this5;
    }
    _createClass2(B, [{
      key: "destroy",
      value: function destroy() {
        var t = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : !0;
        this._clear(), _get2(_getPrototypeOf2(B.prototype), "destroy", this).call(this, t);
      }
    }, {
      key: "_setDisplay",
      value: function _setDisplay(t) {
        _get2(_getPrototypeOf2(B.prototype), "_setDisplay", this).call(this, t), this._isRoot && this._onDisplay(t);
      }
    }, {
      key: "_onDisplay",
